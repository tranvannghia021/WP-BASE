          ...
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_color_2" id="anc_6310_box_border_color_2" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".55" value="<?php echo $cssData['box_border_color_2'] ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_color_3" id="anc_6310_box_border_color_3" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".55" value="<?php echo $cssData['box_border_color_3'] ?>">
                </td>
              </tr>  
              <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_hover_color_2" id="anc_6310_box_border_hover_color_2" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_border_hover_color_2'] ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_border_hover_color_3" id="anc_6310_box_border_hover_color_3" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['box_border_hover_color_3'] ?>">
                </td>
              </tr>
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="number" name="icon_background_size" value="<?php echo $cssData['icon_background_size'] ?>" class="anc-6310-form-input" id="anc_6310_icon_background_size">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="number" name="icon_border_size" value="<?php echo $cssData['icon_border_size'] ?>" class="anc-6310-form-input" id="anc_6310_icon_border_size">
                </td>
              </tr>
              <tr height="45">
                <td><b>Margin Bottom</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
          ...
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_background_color" id="anc_6310_icon_background_color" class="anc-6310-form-input anc_6310_color_picker"  data-format="rgb" value="<?php echo $cssData['icon_background_color'] ?>">
                </td>
              </tr>
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_background_hover_color" id="anc_6310_icon_background_hover_color" class="anc-6310-form-input anc_6310_color_picker"  data-format="rgb" value="<?php echo $cssData['icon_background_hover_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_color" id="anc_6310_icon_border_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['icon_border_color'] ?>">
                </td>
              </tr>           
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_hover_color" id="anc_6310_icon_border_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_border_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
