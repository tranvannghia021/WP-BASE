          ...
          <div class="anc-6310-tab-6">
            <table width="100%">
              ...
              <tr height="45">
                ...
                <td>
                  <input type="text" name="box_background_color" id="anc_6310_box_background_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".55" value="<?php echo $cssData['box_background_color'] ?>">
                </td>
              </tr>
              <tr height="45">
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                ...
                <td>
                  <input name="icon_border_size" id="anc_6310_icon_border_size" type="number" value="<?php echo $cssData['icon_border_size'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_color" id="anc_6310_icon_border_color" class="anc-6310-form-input anc_6310_color_picker" data-format="rgb" data-opacity=".8" value="<?php echo $cssData['icon_border_color'] ?>">
                </td>
              </tr>
              <tr height="45">
                ...
                <td>
                  <input type="text" name="icon_border_hover_color" id="anc_6310_icon_border_hover_color" class="anc-6310-form-input anc_6310_color_picker" data-opacity=".8" data-format="rgb" value="<?php echo $cssData['icon_border_hover_color'] ?>">
                </td>
              </tr>
            </table>
          </div>
          <div class="anc-6310-tab-6">
            ...
            <tr height="45">
                ...
                <td>
                  <input name="icon_background_size" id="anc_6310_icon_background_size" type="number" value="<?php echo $cssData['icon_background_size'] ?>" class="anc-6310-form-input" />
                </td>
              </tr>
            </table>
          </div>
