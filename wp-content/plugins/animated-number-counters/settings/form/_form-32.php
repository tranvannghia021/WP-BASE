        ...
        <div class="row anc_6310_padding_15_px">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td width="55%">
                  <b>Background Image</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span>
                  <div class="anc-6310-tooltip">(No preview available)</div>
                </td>
                <td>
        ...
        <div class="row">
          ...
          <div class="anc-6310-tab-6">
            <table class="table table-responsive anc_6310_admin_table">
              ...
              <tr height="45">
                <td><b>Icon Line Height</b>  <span class="anc-6310-pro">(Pro) <div class="anc-6310-pro-text">This feature is available on the pro version only. You can view changes in the admin panel, not in the output.</div></span></td>
                <td>
              ...
              <tr height="45">
                ...
                <td>
                  <select name="number_text_align" class="anc-6310-form-input" id="anc_6310_number_text_align">
                    ...
                    <option value="flex-start" <?php if ($cssData['number_text_align'] == 'flex-start') echo " selected=''" ?>>Left</option>
                    <option value="flex-end" <?php if ($cssData['number_text_align'] == 'flex-end') echo " selected=''" ?>>Right</option>
                  </select>
                </td>
              </tr>
              <tr height="45">
