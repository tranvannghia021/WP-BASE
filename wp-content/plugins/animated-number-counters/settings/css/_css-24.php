...
.anc-6310-counter-24:after{
  ...
  width: 100%;
  height: 75%;
  background: linear-gradient(to right,<?php echo $cssData['box_background_color']?>,<?php echo $cssData['box_background_color_2']?>);
  position: absolute;
  bottom: 0;
  left: 0;
  z-index: -1;
...
.anc-6310-counter-24:hover:after{  box-shadow: 0 0 <?php echo ($cssData['box_shadow_blur'] * 2) ?>px <?php echo $cssData['box_shadow_width'] ?>px <?php echo $cssData['box_shadow_color'] ?>; }
...
.anc-6310-counter-24:hover .anc-6310-counter-24-icon , .anc-6310-counter-24:hover .anc-6310-counter-24-icon img{
...
.anc-6310-counter-23:hover .anc-6310-counter-24-number{
