...
.anc-6310-counter-15-common-overlay iframe {
  position: absolute;
  top: -100%;
  left: 0;
  width: 100%;
...
.anc-6310-counter-15-common-overlay{
  background-color: <?php echo $cssData['image_overlay_color'] ?>;
  overflow: hidden;
  font-size: 0;
  position: relative;
}
.anc-6310-counter-15-common-overlay:hover{
...
.anc-6310-counter-15-icon i, .anc-6310-counter-15-icon img{
  position: absolute;
  top: 50%;
...
.anc-6310-counter-15:hover .anc-6310-counter-15-icon i, .anc-6310-counter-15:hover .anc-6310-counter-15-icon img{
