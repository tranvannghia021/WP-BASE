...
.anc-6310-counter-23-common-overlay iframe {
  position: absolute;
  top: -100%;
  left: 0;
  width: 100%;
...
.anc-6310-counter-23-common-overlay{
  overflow: hidden;
  font-size: 0;
  position: relative;
}
.anc-6310-counter-23-row {
  padding-top: 30px;
  overflow: hidden;
  font-size: 0;
  display: flex;
...
.anc-6310-counter-23-icon{
    ...
    width: <?php echo $cssData['icon_border_width']?>px;
    height:<?php echo $cssData['icon_border_width']?>px;
    line-height: <?php echo $cssData['icon_border_width']?>px;
    border-radius: 50%;
    border: 3px solid <?php echo $cssData['icon_border_color']?>;
...
.anc-6310-counter-23-icon img{
    display: inline-block;
    border-radius: 50%;
    position: relative;
    height: auto;
}
.anc-6310-counter-23-icon img:before{
    content: "";
    border: 2px solid <?php echo $cssData['icon_border_color']?>;
    border-radius: 50%;
    position: absolute;
    top: 5px;
    left: 5px;
...
.anc-6310-counter-23:hover .anc-6310-counter-23-icon{
  border: 3px solid <?php echo $cssData['icon_border_hover_color']?>;
  color:<?php echo $cssData['icon_hover_color']?>
}

.anc-6310-counter-23:hover .anc-6310-counter-23-icon:before{
  border: 3px solid <?php echo $cssData['icon_border_hover_color']?>;
}


.anc-6310-counter-23-number {
  letter-spacing: 2px;
  width: inherit;
  display: flex;
  justify-content: center;
...
.anc-6310-counter-23:hover .anc-6310-counter-23-number{
...
.anc-6310-counter-23:hover .anc-6310-counter-23-title {
...
.anc-6310-counter-23-count-prefix {
...
.anc-6310-counter-23:hover .anc-6310-counter-23-count-prefix {
...
.anc-6310-counter-23-count-suffix {
...
.anc-6310-counter-23:hover .anc-6310-counter-23-count-suffix {
...
.anc-6310-counter-23-description{
...
.anc-6310-counter-23:hover .anc-6310-counter-23-description{
...
.anc-6310-counter-23-button:hover {
...
.anc-6310-counter-23-button:hover a {
