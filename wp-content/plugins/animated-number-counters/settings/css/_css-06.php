...
.anc-6310-counter-06-common-overlay iframe {
  position: absolute;
  top: -100%;
  left: 0;
  width: 100%;
...
.anc-6310-counter-06-common-overlay{
  background-color: <?php echo $cssData['image_overlay_color'] ?>;
  overflow: hidden;
  font-size: 0;
  position: relative;
}
.anc-6310-counter-06-common-overlay:hover{
...
.anc-6310-counter-06-icon i, .anc-6310-counter-06-icon img {
  float: left;
...
.anc-6310-counter-06-icon img {
  margin-left: <?php echo $cssData['icon_margin_left'] ?>px;
  margin-right: <?php echo $cssData['icon_margin_right'] ?>px;
  margin-top: <?php echo $cssData['icon_margin_top'] ?>px;
  margin-bottom: <?php echo $cssData['icon_margin_bottom'] ?>px;
}
.anc-6310-counter-06:hover .anc-6310-counter-06-icon i, .anc-6310-counter-06-icon img{
