<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 1;
      ...
      include anc_6310_plugin_url . 'settings/form/_form-28.php';
      include anc_6310_plugin_url . 'settings/css/_css-28.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-28.php';
      ?>
              ...
              ?>
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-28">
                    <div class="anc-6310-counter-28-top-wrap">
                      <div class="anc-6310-counter-28-icon"> <?php anc_6310_icon_image_load($allCounter); ?></div>
                      <div class="anc-6310-counter-28-inner-wrap">
                        <div class="anc-6310-counter-28-number-content">
                          <div class="anc-6310-counter-28-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-28-number anc-6310-counter-number" 

                                anc-6310-counter-28-count-number anc-6310-animated-counter-28 anc-6310-counter-number
                          ...
                          <div class="anc-6310-counter-28-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        <div class="anc-6310-counter-28-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      </div>
                    </div>                   
