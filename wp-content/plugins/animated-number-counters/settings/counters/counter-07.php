                              ...
                              <div class="anc-6310-counter-07">
                                 <div class="anc-6310-counter-07-count-content">
                                    ...
                                    <div class="anc-6310-counter-07-count-content-inner">
                                       <div 
                                       class="anc-6310-counter-07-count-number anc-6310-counter-number" 
                                 ...
                                 <div class="anc-6310-counter-07-count-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                                 <div class="anc-6310-counter-07-count-subtitle"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                                 <?php
                                    if($allCounter['readmore_text'] != '') {    
                                 ?>
                                 <div class="anc-6310-counter-07-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                                 <?php
                             }
                           ?>
                              </div>
