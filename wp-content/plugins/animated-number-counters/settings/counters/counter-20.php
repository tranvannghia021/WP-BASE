<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 2;
      ...
      <div class="anc_6310_tabs_panel_preview">
        <div id="anc-6310-number-counter">
          ...
          <div class="anc-6310-counter-20-common-overlay">
            <?php
                if($bgType == 4) {
                ...
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-20">
                    <div class="anc-6310-counter-20-top-wrap">
                      <div class="anc-6310-counter-20-icon"> <?php anc_6310_icon_image_load($allCounter); ?></div>
                      <div class="anc-6310-counter-20-inner-wrap">
                        <div class="anc-6310-counter-20-number-content">
                          <div class="anc-6310-counter-20-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-20-number anc-6310-counter-number" 

                                anc-6310-counter-20-count-number anc-6310-animated-counter-20 anc-6310-counter-number
                        ...
                        <div class="anc-6310-counter-20-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      </div>
                    </div>
                    <div class="anc-6310-counter-20-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                    <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                    <div class="anc-6310-counter-20-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                    <?php
                             }
                           ?>
                  </div>
