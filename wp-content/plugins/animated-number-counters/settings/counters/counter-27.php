<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 1;
      ...
      include anc_6310_plugin_url . 'settings/form/_form-27.php';
      include anc_6310_plugin_url . 'settings/css/_css-27.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-27.php';
      ?>
              ...
              ?>
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                    <div class="anc-6310-counter-27">
                        <div class="anc-6310-counter-27-icon"> <?php anc_6310_icon_image_load($allCounter); ?> </div>
                        <div class="anc-6310-counter-27-content">
                          <div class="anc-6310-counter-27-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                            <div class="anc-6310-counter-27-number-content">
                              <div class="anc-6310-counter-27-count-prefix"><?php echo $numbersPosition[0] ?></div>
                                <div 
                                    class="anc-6310-counter-27-number anc-6310-counter-number" 

                                    anc-6310-counter-27-count-number anc-6310-animated-counter-27 anc-6310-counter-number
                              ...
                              <div class="anc-6310-counter-27-count-suffix"><?php echo $numbersPosition[1] ?></div>
                            </div>
                        </div>
                    </div>
                </div>
