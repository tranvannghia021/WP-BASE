                  ...
                  <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                    <div class="anc-6310-counter-14">
                      ...
                      <div class="anc-6310-counter-14-count-content">
                        <div 
                            class="anc-6310-counter-14-number anc-6310-counter-number" 
                      ...
                      <div class="anc-6310-counter-14-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      <div class="anc-6310-counter-14-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                      <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                      <div class="anc-6310-counter-14-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                      <?php
                             }
                           ?>
                    </div>
