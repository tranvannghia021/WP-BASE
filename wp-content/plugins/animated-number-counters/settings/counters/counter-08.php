<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    ?>
      ...
      <?php $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 1;
...
<div class="anc-6310-plugin-setting-left">
      ...
      <div class="anc_6310_tabs_panel_preview">
        <div id="anc-6310-number-counter">
         <div class="anc-6310-counter-08-paralax">
           <div class="anc-6310-counter-08-common-overlay">
           <?php
              if($bgType == 4) {
           ...
           <div class="anc-6310-counter-08-row">
            ...
            ?>
              <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                ...
                <div class="anc-6310-counter-08-icon"><?php anc_6310_icon_image_load($allCounter); ?></div>
                <div class="anc-6310-counter-08-count-content">
                        <div class="anc-6310-counter-08-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          <div 
                              class="anc-6310-counter-08-number anc-6310-counter-number" 
                      ...
                      <div class="anc-6310-counter-08-count-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      <div class="anc-6310-counter-08-count-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                      <?php
                      if ($allCounter['readmore_text'] != '') {
                      ?>
                        <div class="anc-6310-counter-08-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                      <?php
                      }
                      ?>
                </div>
