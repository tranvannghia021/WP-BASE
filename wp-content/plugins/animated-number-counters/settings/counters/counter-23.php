<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    ?>
      ...
      include anc_6310_plugin_url . 'settings/form/_form-23.php';
      include anc_6310_plugin_url . 'settings/css/_css-23.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-23.php';
      ?>
              ...
              ?>
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">                 
                    <div class="anc-6310-counter-23">
                      <div class="anc-6310-counter-23-icon"><?php anc_6310_icon_image_load($allCounter); ?> </div>
                        <div class="anc-6310-counter-23-number-content">
                            <div class="anc-6310-counter-23-count-prefix"><?php echo $numbersPosition[0] ?></div>
                              <div 
                                  class="anc-6310-counter-23-number anc-6310-counter-number" 

                                  anc-6310-counter-23-count-number anc-6310-animated-counter-23 anc-6310-counter-number
                            ...
                            <div class="anc-6310-counter-23-count-suffix"><?php echo $numbersPosition[1] ?></div>
                          </div>
                      <div class="anc-6310-counter-23-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      <div class="anc-6310-counter-23-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                        <?php
                            if($allCounter['readmore_text'] != '') {    
                          ?>
                          <div class="anc-6310-counter-23-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                          <?php
                              }
                            ?>
                    </div>                  
