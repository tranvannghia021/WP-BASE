                      ...
                      <div class="anc-6310-counter-19">
                        <div class="anc-6310-counter-19-top-wrap">
                          ...
                          <div class="anc-6310-counter-19-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-19-number anc-6310-counter-number" 
                        ...
                        <div class="anc-6310-counter-19-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                        <div class="anc-6310-counter-19-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                        <?php
                          if($allCounter['readmore_text'] != '') {    
                        ?>
                        <div class="anc-6310-counter-19-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                        <?php
                             }
                           ?>
                      </div>
