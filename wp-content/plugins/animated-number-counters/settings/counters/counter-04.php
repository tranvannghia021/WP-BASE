              ...
              <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                <div class="anc-6310-counter-04">
                    ...
                    <div class="anc-6310-counter-04-top-inner-wrap">
                      <div class="anc-6310-counter-04-count-content">
                        ...
                        <div class="anc-6310-counter-04-count-content-inner">
                          <div 
                              class="anc-6310-counter-04-count-number anc-6310-counter-number" 
                      ...
                      <div class="anc-6310-counter-04-count-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      <div class="anc-6310-counter-04-count-subtitle"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                      <?php
                      if ($allCounter['readmore_text'] != '') {
                      ?>
                        <div class="anc-6310-counter-04-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                      <?php
                      }
                      ?>
                    </div>
                  ...
                  <div class="anc-6310-counter-04-bottom-container">
                    <div class="anc-6310-counter-04-featured-item"><span><?php anc_6310_icon_image_load($allCounter); ?></i></span></div>
                  </div>
                </div>
              </div>
            <?php
