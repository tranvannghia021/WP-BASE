    ...
    <div class="anc-6310-plugin-setting-left">
      ...
      <div class="anc_6310_tabs_panel_preview">
        <div id="anc-6310-number-counter">
          ...
          <div class="anc-6310-counter-10-common-overlay">
                ...
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-10">
                   <div class="anc-6310-counter-10-top-wrap">
                    <div class="anc-6310-counter-10-icon"><?php anc_6310_icon_image_load($allCounter); ?>"></i></div>
                      <div class="anc-6310-counter-10-inner-wrap">
                        <div class="anc-6310-counter-10-number-content">
                          <div class="anc-6310-counter-10-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-10-number anc-6310-counter-number" 
                                ...
                                data-anc-6310-duration="<?php echo isset($cssData['animation_duration']) && $cssData['animation_duration'] !== '' ? $cssData['animation_duration'] / 1000 : .5; ?>" data-anc-6310-thousands-separator="<?php echo isset($cssData['thousands_separator']) ? $cssData['thousands_separator'] : '' ?>" 
                              >
                                <?php echo $allCounter['numbers_start']; ?>
                              </div>
                          <div class="anc-6310-counter-10-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        <div class="anc-6310-counter-10-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      </div>
                    </div>
                    <div class="anc-6310-counter-10-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                    <?php
                    if ($allCounter['readmore_text'] != '') {
                    ?>
                      <div class="anc-6310-counter-10-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                    <?php
                    }
                    ?>
                  </div>
