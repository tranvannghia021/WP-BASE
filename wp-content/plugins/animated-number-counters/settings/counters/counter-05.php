  ...
  <br class="anc-6310-clear" />
                      ...
                      <div class="anc-6310-counter-05-bottom-container">
                        ...
                        <div class="anc-6310-counter-05-count-content">
                          ...
                          <div class="anc-6310-counter-05-count-content-inner">
                            <div 
                                class="anc-6310-counter-05-count-number anc-6310-counter-number" 
                        ...
                        <div class="anc-6310-counter-05-count-content anc-6310-counter-05-count-content-hidden">
                          <div class="anc-6310-counter-05-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          <div class="anc-6310-counter-05-count-content-inner">
                            <div class="anc-6310-counter-05-count-number">
                            <?php echo $allCounter['numbers']; ?>
                            </div>
                          </div>
                          <div class="anc-6310-counter-05-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>

                        <div class="anc-6310-counter-05-count-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                        <div class="anc-6310-counter-05-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                        <?php
                        if ($allCounter['readmore_text'] != '') {
                        ?>
                          <div class="anc-6310-counter-05-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                        <?php
                        }
                        ?>
                      </div>
    ...
    <script>
      jQuery(document).ready(function(){
        setTimeout(() => {
          let content = jQuery('.anc-6310-counter-05-count-content-hidden');
          content.each(function(){
            let width = jQuery(this).width() + 20;
            jQuery(this).siblings('.span1').css({
