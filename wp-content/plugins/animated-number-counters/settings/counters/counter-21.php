<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    include anc_6310_plugin_url . 'settings/form/_form-21.php';
    include anc_6310_plugin_url . 'settings/css/_css-21.php';
    include anc_6310_plugin_url . 'settings/helper/_helper-21.php';
    ?>
          ...
          <div class="anc-6310-counter-21-row">
              ...
              <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-21">
                    <div class="anc-6310-counter-21-top-wrap">                     
                      <div class="anc-6310-counter-21-inner-wrap">
                        <div class="anc-6310-counter-21-number-content">
                          <div class="anc-6310-counter-21-wrapper">  
                            <div class="final-animation">
                            <div class="anc-6310-counter-21-count-prefix"><?php echo $numbersPosition[0] ?></div>
                              <div 
                                  class=" anc-6310-counter-21-number anc-6310-counter-number" 
                                  anc-6310-counter-21-count-number anc-6310-animated-counter-21 anc-6310-counter-number
                            ...
                            <div class="anc-6310-counter-21-count-suffix"><?php echo $numbersPosition[1] ?></div>
                            </div>
                        ...
                        <div class="anc-6310-counter-21-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      </div>
                    </div>
                    <div class="anc-6310-counter-21-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                    <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                    <div class="anc-6310-counter-21-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                    <?php
                             }
                           ?>
                  </div>
