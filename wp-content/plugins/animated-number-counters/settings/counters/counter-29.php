<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 3;
      ...
      include anc_6310_plugin_url . 'settings/form/_form-29.php';
      include anc_6310_plugin_url . 'settings/css/_css-29.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-29.php';
      ?>
              ...
              ?>
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                  <div class="anc-6310-counter-29">
                    <div class="anc-6310-counter-29-top-wrap">
                      <div class="anc-6310-counter-29-inner-wrap">
                        <div class="anc-6310-counter-29-number-content">
                          <div class="anc-6310-counter-29-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-29-number anc-6310-counter-number" 

                                anc-6310-counter-29-count-number anc-6310-animated-counter-29 anc-6310-counter-number
                          ...
                          <div class="anc-6310-counter-29-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        <div class="anc-6310-counter-29-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                        <div class="anc-6310-counter-29-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                    <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                    <div class="anc-6310-counter-29-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                    <?php
                             }
                           ?>
                      </div>
                    ...
                    <div class="anc-6310-counter-29-icon"> <?php anc_6310_icon_image_load($allCounter); ?></div>                   
                  </div>
                </div>
              <?php
              }
