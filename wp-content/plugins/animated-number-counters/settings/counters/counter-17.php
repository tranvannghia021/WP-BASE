                ...
                ?>
                  <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                    <div class="anc-6310-counter-17">
                      <div class="anc-6310-counter-17-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      ...
                      <?php anc_6310_icon_image_load($allCounter); ?>
                        <div class="anc-6310-counter-17-number-content">
                          <div class="anc-6310-counter-17-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-17-number anc-6310-counter-number" 
                      ...
                      <div class="anc-6310-counter-17-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                      <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                      <div class="anc-6310-counter-17-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                      <?php
                             }
                           ?>
                    </div>
