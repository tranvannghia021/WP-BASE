  ...
  <br class="anc-6310-clear" />
    ...
    <div class="anc-6310-plugin-setting-left">
      ...
      <div class="anc_6310_tabs_panel_preview">
        ...
        <div class="anc-6310-counter-06-paralax">
          <div class="anc-6310-counter-06-common-overlay">
          <?php
              if($bgType == 4) {
            ...
            ?>
              <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                <div class="anc-6310-counter-06">
                  ...
                  <?php anc_6310_icon_image_load($allCounter); ?>
                    <div class="anc-6310-counter-06-number-content">
                      <div class="anc-6310-counter-06-count-prefix"><?php echo $numbersPosition[0] ?></div>
                        <div 
                            class="anc-6310-counter-06-count-number anc-6310-counter-number" 
                  ...
                  <div class="anc-6310-counter-06-count-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                  <div class="anc-6310-counter-06-count-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                  <?php
                    if($allCounter['readmore_text'] != '') {    
                  ?>
                  <div class="anc-6310-counter-06-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                  <?php
                    }
                  ?>
                </div>
