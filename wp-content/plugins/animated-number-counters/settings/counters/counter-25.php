<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 3;
      ...
      include anc_6310_plugin_url . 'settings/form/_form-25.php';
      include anc_6310_plugin_url . 'settings/css/_css-25.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-25.php';
      ?>
                ...
                <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                      <div class="anc-6310-counter-25">
                        <div class="anc-6310-counter-25-content">
                          ...
                          <div class="anc-6310-counter-25-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                          <?php
                          if ($allCounter['readmore_text'] != '') {
                          ?>
                            <div class="anc-6310-counter-25-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                          <?php
                          }
                          ?>
                         <div class="anc-6310-counter-25-number-content">
                          <div class="anc-6310-counter-25-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-25-number anc-6310-counter-number" 

                                anc-6310-counter-25-count-number anc-6310-animated-counter-25 anc-6310-counter-number
                          ...
                          <div class="anc-6310-counter-25-count-suffix"><?php echo $numbersPosition[1] ?></div>
                        </div>
                        </div>
