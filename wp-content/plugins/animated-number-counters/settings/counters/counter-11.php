                ...
                <div class="anc-6310-counter-11-row-item">
                  ...
                  ?>
                    <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                      ...
                      <div class="anc-6310-counter-11-icon-wrapper">  <div class="anc-6310-counter-11-icon"><?php anc_6310_icon_image_load($allCounter); ?></div></div>
                        <div class="anc-6310-counter-11-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                        <div class="anc-6310-counter-11-count-prefix"><?php echo $numbersPosition[0] ?></div>
                          <div 
                            class="anc-6310-counter-11-number anc-6310-counter-number" 
                        ...
                        <div class="anc-6310-counter-11-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                        <?php
                          if($allCounter['readmore_text'] != '') {    
                        ?>
                        <div class="anc-6310-counter-11-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                        <?php
                             }
                           ?>
                      </div>
