<div class="anc-6310-6310">
  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 1;
      ...
      include anc_6310_plugin_url . 'settings/form/_form-26.php';
      include anc_6310_plugin_url . 'settings/css/_css-26.php';
      include anc_6310_plugin_url . 'settings/helper/_helper-26.php';
      ?>
