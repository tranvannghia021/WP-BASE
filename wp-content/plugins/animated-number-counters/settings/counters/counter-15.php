		...
		$bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 2;
			...
			<div class="anc_6310_tabs_panel_preview">
				<div id="anc-6310-number-counter">
					...
					<div class="anc-6310-counter-15-common-overlay">
						<?php
								if($bgType == 4) {
							...
							?>
								<div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
									<div class="anc-6310-counter-15">
										<div class="anc-6310-counter-15-icon"><?php anc_6310_icon_image_load($allCounter); ?></div>
										<div class="anc-6310-counter-15-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
										<div class="anc-6310-counter-15-number-content">
											<div class="anc-6310-counter-15-count-prefix"><?php echo $numbersPosition[0] ?></div>
												<div 
														class="anc-6310-counter-15-number anc-6310-counter-number" 
										...
										<div class="anc-6310-counter-15-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
										<?php
                        					if($allCounter['readmore_text'] != '') {    
                     	 				?>
										<div class="anc-6310-counter-15-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
										<?php
                             }
                           ?>
									</div>
