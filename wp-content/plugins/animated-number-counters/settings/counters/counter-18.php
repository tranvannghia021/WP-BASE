  ...
  <br class="anc-6310-clear" />
    ...
    $bgType = isset($cssData['background_type']) ? $cssData['background_type'] : 1;
      ...
      <div class="anc_6310_tabs_panel_preview">
        ...
        <div class="anc-6310-counter-18-paralax">
          <div class="anc-6310-counter-18-common-overlay">
            <?php
                if($bgType == 4) {
                ...
                <div class="anc-6310-counter-18 anc-6310-counter-18-box-<?php echo ($boxItem) ? $boxItem : '6' ?>">
                  ...
                  <?php anc_6310_icon_image_load($allCounter); ?>
                    <div class="anc-6310-counter-18-number-content">
                      ...
                      <div 
                          class="anc-6310-counter-18-number anc-6310-counter-number" 
                  ...
                  <div class="anc-6310-counter-18-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                  <div class="anc-6310-counter-18-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                  <?php
                    if($allCounter['readmore_text'] != '') {    
                  ?>
                  <div class="anc-6310-counter-18-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                  <?php
                             }
                           ?>
                </div>
