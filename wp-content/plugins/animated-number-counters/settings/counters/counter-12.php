                ...
                ?>
                  <div class="anc-6310-col-<?php echo $cssData['item_per_row'] ?>">
                    <div class="anc-6310-counter-12">
                      <div class="anc-6310-counter-12-title"><?php echo anc_6310_special_character_remove($allCounter['title']) ?></div>
                      <div class="anc-6310-counter-12-inner-wrap">
                        ...
                        <div class="anc-6310-counter-12-number-content">
                          <div class="anc-6310-counter-12-count-prefix"><?php echo $numbersPosition[0] ?></div>
                            <div 
                                class="anc-6310-counter-12-number anc-6310-counter-number" 
                      ...
                      <div class="anc-6310-counter-12-description"><?php echo anc_6310_special_character_remove($allCounter['description']) ?></div>
                      <?php
                        if($allCounter['readmore_text'] != '') {    
                      ?>
                      <div class="anc-6310-counter-12-button"><a href="<?php echo $allCounter['readmore_url'] ?>" target="_blank"><?php echo anc_6310_special_character_remove($allCounter['readmore_text']) ?></a></div>
                      <?php
                             }
                           ?>
                    </div>
